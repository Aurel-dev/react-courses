        ...
        return (
            <div className="card">
                <form className="admin-form ajouter-recette" onSubmit={this.handleSubmit}>
                    ...
                    <textarea value={this.state.ingredients} onChange={this.handleChange} name="ingredients" id="" cols="3" rows="10" placeholder='Liste des ingrédients' />
                    <textarea value={this.state.instructions} onChange={this.handleChange} name="instructions" id="" cols="15" rows="10" placeholder='Liste des instructions' />
